    ...
    <div className="breadcrumbs">breadcrumbs</div>
      ...
      <div className="custom-header-media overlaying-image">
        <div className="hero gp-top">
          {/* I think I might just take this back to a regular js that I build myself */}
          {/* no script Cross fading images aka slider aka carousel http://css3.bradshawenterprises.com/cfimg/ */}
          <div className="cfimg">

            {/* gatsby image */}
            <picture>
              <img src="/assets/slider/Riley-Bathurst-adventure-360x240.jpg" alt="riley bathurst photographer and outdoors enthusiast" />
            </picture>

            <picture>
              <img src="/assets/slider/Riley-Bathurst-energy-360x240.jpg" alt="riley bathurst designer with energy" />
            </picture>

            <picture>
              <img src="/assets/slider/Riley-Bathurst-motorbike-photography-360x240.jpg" alt="riley bathurst photographer with style" />
            </picture>

            <picture>
              <img src="/assets/slider/Riley-Bathurst-portrait-360x240.jpg" alt="riley bathurst designer in the wilderness" />
            </picture>

            <picture>
              <img src="/assets/slider/Riley-Bathurst-photography-profile-360x240.jpg" alt="riley bathurst designer in tahoe" />
            </picture>
          </div> {/* .cfimg */}
        </div> {/* .hero .gp-top */}
