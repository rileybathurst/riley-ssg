  ...
  <footer class="site-footer">
    ...
    <div class="background-dirty footer-background__step">
        ...
        <div class="background-primary background-primary__social-icons">
          <div class="front-page-titles"> {/* this should be renamed to something more generic if its being used in multiplaces */}
            {/* <div class="fp-box ccc-west"></div> I had this removed in wp? */}
          ...
          {/* <div class="fp-box ccc-east"></div> this had been removed in wp */}
